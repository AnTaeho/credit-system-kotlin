...
[`docs/legacy-steps/step7-observability.md`](../../docs/legacy-steps/step7-observability.md) 의 4·5단계를 봐라.
...
[`docs/legacy-steps/step7-observability.md`](../../docs/legacy-steps/step7-observability.md) 의 6단계에 있고,
07·08 의 해석과 step11 재실행 상태(01·02 만 실측하고 중단됐다)는 [`docs/legacy-steps/step11-external.md`](../../docs/legacy-steps/step11-external.md) 에 있다.
...
[`docs/legacy-steps/step7-observability.md`](../../docs/legacy-steps/step7-observability.md) 의 `## 후속 3` 에 있다.
