...
카드의 기댓값은 [`docs/legacy-steps/step7-observability.md`](../../../docs/legacy-steps/step7-observability.md) 6단계
결과 매트릭스와 후속 1 실측에서 옮긴 것이고, 07(지연 → 타임아웃)과 08(멈춘 워커)은
[`docs/legacy-steps/step11-external.md`](../../../docs/legacy-steps/step11-external.md) 의 재실행 실측이다.
