...
- 코드 주석(`IdempotencyKeyCleanupTask`)의 "보존 기간이 7일이라 하루 한 번이면 충분하다"는
  **cron 주기의 근거**이지 7일 자체의 근거가 아니다. `docs/step6-resilience.md:174` 도 같은 문장을
  옮긴 것이다.
